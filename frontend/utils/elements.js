...
export default class Elements {
    ...
    createInfoElement(type, sign, amount, extraClass, text, showText, onDelete) {
        ...
        const rightSide = this.createContainer(`main_${type}_item_right`);
        rightSide.appendChild(amountText);

        if (typeof onDelete === "function") {
            const deleteButton = document.createElement("button");
            deleteButton.classList.add("main_item_delete");
